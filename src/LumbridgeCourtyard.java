...
public class LumbridgeCourtyard extends JPanel implements KeyListener
{
	...
	private JLabel lblCastle;
	private JLabel lblMainArea;
	private JLabel lblSameBuilding;
	private JLabel lblChurch;
	private JLabel lblMainChurch;
	private JLabel lblFence;
	private JLabel lblSouthBuilding;
	private JLabel lblFence2;
	private JLabel lblSouthChurch;
	private JLabel lblBoundary;
	private JLabel lblSouthCastle;
	private JLabel lblNorthCastle;
	...
	public LumbridgeCourtyard(JFrame pParentFrame, int piID, int piX, int piY, AudioPlayer introSound)
	{
		...
		panelInterface.addKeyListener(this);
		panelInterface.setFocusable(true);
		
		panelInterface.setFocusable(true);
		panelInterface.requestFocusInWindow();
		

		lblCharacter = new JLabel("");
		lblCharacter.setBounds(x, y, 17, 21);
		panelInterface.add(lblCharacter);
		lblCharacter.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\Misc\\Front Side Character.png"));
		
		lblBuilding = new JLabel("");
		lblBuilding.setBounds(95, 207, 111, 96);
		panelInterface.add(lblBuilding);
		
		lblCastle = new JLabel("");
		lblCastle.setBounds(119, 57, 25, 51);
		panelInterface.add(lblCastle);
		
		lblMainArea = new JLabel("");
		lblMainArea.setBounds(156, 0, 104, 3);
		panelInterface.add(lblMainArea);
		
		lblSameBuilding = new JLabel("");
		lblSameBuilding.setBounds(0, 298, 189, 112);
		panelInterface.add(lblSameBuilding);
		
		lblChurch = new JLabel("New label");
		lblChurch.setBounds(268, 175, 39, 89);
		panelInterface.add(lblChurch);
		
		lblMainChurch = new JLabel("");
		lblMainChurch.setBounds(305, 0, 248, 339);
		panelInterface.add(lblMainChurch);
		
		lblFence = new JLabel("");
		lblFence.setBounds(250, 317, 1, 25);
		panelInterface.add(lblFence);
		
		lblFence2 = new JLabel("");
		lblFence2.setBounds(250, 314, 40, 1);
		panelInterface.add(lblFence2);
		
		lblSouthBuilding = new JLabel("");
		lblSouthBuilding.setBounds(189, 399, 56, 11);
		panelInterface.add(lblSouthBuilding);
		
		lblSouthChurch = new JLabel("");
		lblSouthChurch.setBounds(359, 338, 194, 72);
		panelInterface.add(lblSouthChurch);
		
		lblBoundary = new JLabel("");
		lblBoundary.setBounds(250, 2, 303, 72);
		panelInterface.add(lblBoundary);
		
		lblSouthCastle = new JLabel("");
		lblSouthCastle.setBounds(67, 104, 88, 90);
		panelInterface.add(lblSouthCastle);
		
		lblNorthCastle = new JLabel("");
		lblNorthCastle.setBounds(67, 0, 88, 57);
		panelInterface.add(lblNorthCastle);
		
		JLabel lblInGame = new JLabel("");
		lblInGame.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\In Game\\Lumbridge Courtyard.png"));
		lblInGame.setBounds(0, 0, 553, 410);
		panelInterface.add(lblInGame);
	...
	{
		Rectangle one = new Rectangle(lblBuilding.getBounds());
		
		Rectangle two = new Rectangle(lblCharacter.getBounds());
		
		Rectangle three = new Rectangle(lblCastle.getBounds());
		
		Rectangle four = new Rectangle(lblMainArea.getBounds());
		
		Rectangle five = new Rectangle(lblSameBuilding.getBounds());
		
		Rectangle six = new Rectangle(lblChurch.getBounds());
		
		Rectangle seven = new Rectangle(lblMainChurch.getBounds());
		
		Rectangle eight = new Rectangle(lblFence.getBounds());
		
		Rectangle nine = new Rectangle(lblFence2.getBounds());
		
		Rectangle ten = new Rectangle(lblSouthBuilding.getBounds());
		
		Rectangle eleven = new Rectangle(lblSouthChurch.getBounds());
		
		Rectangle twelve = new Rectangle(lblBoundary.getBounds());
		
		Rectangle thirteen = new Rectangle(lblSouthCastle.getBounds());
		
		Rectangle fourteen = new Rectangle(lblNorthCastle.getBounds());
		
		if(two.intersects(one) || two.intersects(five) || two.intersects(six) || two.intersects(seven) || two.intersects(eight) || two.intersects(nine) || two.intersects(ten) 
				|| two.intersects(eleven) || two.intersects(twelve) || two.intersects(thirteen) || two.intersects(fourteen))
		{
			switch(sDirection)
			{
		...
		{
			LumbridgeCastle lc = new LumbridgeCastle(parentFrame, iUserID, 440, 184, music);
			parentFrame.setContentPane(lc);
			parentFrame.revalidate();
			
			return false;
		}
		
		if(two.intersects(four))
		{
			LumbridgeMainArea lma = new LumbridgeMainArea(parentFrame, iUserID, 265, 380, music);
			parentFrame.setContentPane(lma);
			parentFrame.revalidate();
	...
	public void keyPressed(KeyEvent e) 
	{
		...
		{
			lblCharacter.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\Misc\\Right Side.png"));
			lblCharacter.setBounds(moveRight(), y, 17, 21);
			System.out.println("x = " + x + " y = " + y);
		}
		
		if(e.getKeyCode() == KeyEvent.VK_LEFT)
		{
			lblCharacter.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\Misc\\Left Side.png"));
			lblCharacter.setBounds(moveLeft(), y, 17, 21);
			System.out.println("x = " + x + " y = " + y);
		...
		{
			lblCharacter.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\Misc\\Front Side Character.png"));
			lblCharacter.setBounds(x, moveDown(), 17, 21);
			System.out.println("x = " + x + " y = " + y);
		...
		{
			lblCharacter.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\Misc\\Back Side Character.png"));
			lblCharacter.setBounds(x, moveUp(), 17, 21);
			System.out.println("x = " + x + " y = " + y);
