...
public class LumbridgeMap extends JPanel 
{
	...
	public LumbridgeMap(JFrame pParentFrame, int piID) 
	{
		...
		AudioPlayer ap = new AudioPlayer(Sounds.HARMONY, true);
		ap.startSound();
		...
		btnLogOut.addActionListener(new ActionListener() {
			...
			{
				ap.stopSound();
				Lobby l = new Lobby(parentFrame, iUserID, ap);
		...
		btnCastle.addActionListener(new ActionListener() {
			...
			{
				LumbridgeCastle lc = new LumbridgeCastle(parentFrame, iUserID, 391, 179, ap);
				parentFrame.setContentPane(lc);
				parentFrame.revalidate();
			}
		});
		btnCastle.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\In Game Buttons\\Lumbridge Castle Button.png"));
		btnCastle.setBounds(284, 148, 105, 145);
		panelInterface.add(btnCastle);
		
		JButton btnCourtyard = new JButton("");
		btnCourtyard.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				LumbridgeCourtyard lcy = new LumbridgeCourtyard(parentFrame, iUserID, 220, 186, ap);
				parentFrame.setContentPane(lcy);
				parentFrame.revalidate();
			}
		});
		btnCourtyard.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\In Game Buttons\\Lumbridge Courtyard Button.png"));
		btnCourtyard.setBounds(390, 197, 140, 106);
		panelInterface.add(btnCourtyard);
		
		JButton btnMainArea = new JButton("");
		btnMainArea.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				ap.stopSound();
				LumbridgeMainArea lma = new LumbridgeMainArea(parentFrame, iUserID, 265, 385, ap);
				parentFrame.setContentPane(lma);
				parentFrame.revalidate();
			}
		});
		btnMainArea.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\In Game Buttons\\Lumbridge Main Area Button.png"));
		btnMainArea.setBounds(322, 50, 118, 90);
		panelInterface.add(btnMainArea);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\Maps\\Lumbridge Map.png"));
		lblNewLabel.setBounds(0, 0, 553, 410);
		panelInterface.add(lblNewLabel);
