...
public class LumbridgeMainArea extends JPanel implements KeyListener
{
	...
	private JLabel lblSouthFence;
	private JLabel lblSouthWest;
	private JLabel lblSouthEast;
	private JLabel lblSmithing;
	private JLabel lblRiver;
	private JLabel lblEastFence;
	private JLabel lblWestFence;
	private JLabel lblOtherFence;
	...
	public LumbridgeMainArea(JFrame pParentFrame, int piID, int piX, int piY, AudioPlayer introSound)
	{
		...
		panelInterface.requestFocus();
		
		lblCourtyard = new JLabel("New label");
		lblCourtyard.setBounds(216, 409, 92, 1);
		panelInterface.add(lblCourtyard);
		
		lblSouthWest = new JLabel("");
		lblSouthWest.setBounds(0, 253, 209, 157);
		panelInterface.add(lblSouthWest);
		
		lblSouthEast = new JLabel("");
		lblSouthEast.setBounds(308, 218, 245, 192);
		panelInterface.add(lblSouthEast);
		
		lblSmithing = new JLabel("");
		lblSmithing.setBounds(239, 13, 120, 108);
		panelInterface.add(lblSmithing);
		
		lblRiver = new JLabel("");
		lblRiver.setBounds(394, 0, 1, 205);
		panelInterface.add(lblRiver);
		
		lblSouthFence = new JLabel("");
		lblSouthFence.setBounds(113, 170, 56, 1);
		panelInterface.add(lblSouthFence);
		
		JLabel lblInGame = new JLabel("");
		lblInGame.setBackground(Color.BLACK);
		lblInGame.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\In Game\\Lumbridge Main Area.png"));
		lblInGame.setBounds(0, 0, 553, 410);
		panelInterface.add(lblInGame);
		
		lblEastFence = new JLabel("");
		lblEastFence.setBounds(144, 0, 20, 157);
		panelInterface.add(lblEastFence);
		
		lblWestFence = new JLabel("");
		lblWestFence.setBounds(0, 170, 42, 7);
		panelInterface.add(lblWestFence);
		
		lblOtherFence = new JLabel("New label");
		lblOtherFence.setBounds(113, 170, 26, 1);
		panelInterface.add(lblOtherFence);
		
		lblTree = new JLabel("");
		lblTree.setBounds(353, 186, 68, 29);
		panelInterface.add(lblTree);
	...
	public boolean checkCollision()
	{
		...
		Rectangle three = new Rectangle(lblEastFence.getBounds());
		
		Rectangle four = new Rectangle(lblRiver.getBounds());
		
		Rectangle five = new Rectangle(lblSmithing.getBounds());
		
		Rectangle six = new Rectangle(lblSouthEast.getBounds());
		
		Rectangle seven = new Rectangle(lblSouthWest.getBounds());
		
		Rectangle eight = new Rectangle(lblWestFence.getBounds());
		
		Rectangle nine = new Rectangle(lblOtherFence.getBounds());
		
		Rectangle ten = new Rectangle(lblTree.getBounds());
		
		if(one.intersects(two))
		{
			LumbridgeCourtyard lc = new LumbridgeCourtyard(parentFrame, iUserID, 210, 13, music);
		...
		if(one.intersects(three) || one.intersects(four) || one.intersects(five) || one.intersects(six) || one.intersects(seven)
				|| one.intersects(eight) || one.intersects(nine) || one.intersects(ten))
		{
			switch(sDirection)
			{
			case "Up": y += 10;
