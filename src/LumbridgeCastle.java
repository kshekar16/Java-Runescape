...
public class LumbridgeCastle extends JPanel implements KeyListener
{
	...
	private JLabel lblCourtyard;
	
	private JLabel lblEntranceNorth;
	private JLabel lblEntranceSouth;
	private JLabel lblCornerSouth1;
	private JLabel lblCornerSouth2;
	private JLabel lblSouthWall;
	private JLabel lblNorthWall;
	private JLabel lblCornerNorth1;
	private JLabel lblCornerNorth2;
	private JLabel lblWestWall;
	...
	public LumbridgeCastle(JFrame pParentFrame, int piID, int piX, int piY, AudioPlayer introSound)
	{
		...
		lblCharacter = new JLabel("New label");
		...
		lblCourtyard = new JLabel("");
		lblCourtyard.setBounds(469, 181, 11, 27);
		panelInterface.add(lblCourtyard);
		
		lblEntranceNorth = new JLabel("New label");
		lblEntranceNorth.setBounds(333, 71, 1, 106);
		panelInterface.add(lblEntranceNorth);
		
		lblEntranceSouth = new JLabel("New label");
		lblEntranceSouth.setBounds(333, 210, 1, 97);
		panelInterface.add(lblEntranceSouth);
		
		
		JLabel lblInGame = new JLabel("");
		lblInGame.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\In Game\\Lumbridge Castle High.PNG"));
		lblInGame.setBounds(0, 0, 553, 410);
		panelInterface.add(lblInGame);
		
		lblCornerSouth1 = new JLabel("New label");
		lblCornerSouth1.setBounds(323, 309, 11, 27);
		panelInterface.add(lblCornerSouth1);
		
		lblCornerSouth2 = new JLabel("New label");
		lblCornerSouth2.setBounds(310, 338, 11, 16);
		panelInterface.add(lblCornerSouth2);
		
		lblSouthWall = new JLabel("New label");
		lblSouthWall.setBounds(195, 354, 112, 10);
		panelInterface.add(lblSouthWall);
		
		lblNorthWall = new JLabel("New label");
		lblNorthWall.setBounds(206, 40, 101, 10);
		panelInterface.add(lblNorthWall);
		
		lblCornerNorth1 = new JLabel("New label");
		lblCornerNorth1.setBounds(310, 40, 11, 13);
		panelInterface.add(lblCornerNorth1);
		
		lblCornerNorth2 = new JLabel("New label");
		lblCornerNorth2.setBounds(320, 53, 11, 16);
		panelInterface.add(lblCornerNorth2);
		
		lblWestWall = new JLabel("New label");
		lblWestWall.setBounds(166, 63, 11, 273);
		panelInterface.add(lblWestWall);
	...
	{
		Rectangle one = new Rectangle(lblCharacter.getBounds());
		Rectangle two = new Rectangle(lblCourtyard.getBounds());
		Rectangle three = new Rectangle(lblEntranceNorth.getBounds());
		Rectangle four = new Rectangle(lblEntranceSouth.getBounds());
		Rectangle five = new Rectangle(lblCornerSouth1.getBounds());
		Rectangle six = new Rectangle(lblCornerSouth2.getBounds());
		Rectangle seven = new Rectangle(lblSouthWall.getBounds());
		Rectangle eight = new Rectangle(lblNorthWall.getBounds());
		Rectangle nine = new Rectangle(lblCornerNorth1.getBounds());
		Rectangle ten = new Rectangle(lblCornerNorth2.getBounds());
		Rectangle eleven = new Rectangle(lblWestWall.getBounds());
		
		if(one.intersects(two))
		{
			LumbridgeCourtyard lcy = new LumbridgeCourtyard(parentFrame, iUserID, 173, 70, music);
			parentFrame.setContentPane(lcy);
			parentFrame.revalidate();
			
			return false;
		}
		
		if(one.intersects(three) || one.intersects(four) || one.intersects(five) || one.intersects(six) || one.intersects(seven) || one.intersects(eight) 
				|| one.intersects(nine) || one.intersects(ten) || one.intersects(eleven))
		{
			switch(sDirection)
			{
