...
public class VarrockMap extends JPanel
{
	...
	public VarrockMap(JFrame pParentFrame, int piID) 
	{
		...
		lblMap.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\Maps\\Varrock Map.png"));
	...
	public AudioPlayer playMusic()
	{
			...
			AudioPlayer ap = new AudioPlayer(Sounds.AUTUMNVOYAGE, true);
			ap.startSound();
			return ap;
	}
