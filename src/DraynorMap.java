...
public class DraynorMap extends JPanel {
	...
	public DraynorMap(JFrame pParentFrame, int piID) 
	{
		...
		lblMap.setIcon(new ImageIcon("C:\\Users\\kshek\\Java Runescape\\Maps\\Draynor Map.png"));
	...
	public AudioPlayer playMusic()
	{
			...
			AudioPlayer ap = new AudioPlayer(Sounds.DARKNESSINMISTHALIN, true);
			ap.startSound();
			return ap;
	}
